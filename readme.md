...
We build this custom script to make your project setup easier. It will create a new Hugo theme folder, and clone the Hugoplate theme into it. Then move the website folder into the root directory. So that you can start your Hugo server without going into the website folder. Use the following command to setup your project.
